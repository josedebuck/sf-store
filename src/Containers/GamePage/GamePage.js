                      ...
                      >
                        <AnimatedText>
                             <div className={textExtended ? styles.open : styles.closed}>
                                 ...
                                 <h4>Lanzamiento: {selectedGame ? selectedGame.release : templateGame.release}</h4>
                                 <h4>Platformas: {selectedGame ? selectedGame.platforms : templateGame.platforms}</h4>
                                 <h4>Genero: {selectedGame ? selectedGame.genre : templateGame.genre}</h4>
                                 <h4>Desarrolladores: {selectedGame ? selectedGame.developers : templateGame.developers}</h4>
                                 <h4 className={styles.lastChild}>Publicadores: {selectedGame ? selectedGame.publishers : templateGame.publishers}</h4>
                             </div>
                        </AnimatedText>
